...
::: column
In totaal hebben \[BEREKENINGING INVOEGEN\] jongvolwassenen uit Nederland de vragenlijst ingevuld. Van deze respondenten komen `r nrow(monitor_df_regio)` jongvolwassenen uit `r labelled_naar_character(monitor_df_regio, "GGDregio") %>% unique()`.
:::
...
::: {layout="[[30,30,30],[30,30,30]]"}
::: column
`r maak_vergelijking(data = monitor_df, survey_design = design_gem, variabele = 'GZGGA402', variabele_label = "hun eigen gezondheid als (zeer) goed ervaart", vergelijking = 'AGGSA401') `
`r maak_vergelijking(data = monitor_df, survey_design = design_gem, variabele = 'LVPKS403', variabele_label = "psychische klachten heeft", vergelijking = 'AGOJB401')`
:::
