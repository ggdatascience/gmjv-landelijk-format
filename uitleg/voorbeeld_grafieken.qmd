...
#Dit is nodig voor ggplot. lettertypen voor html tekst kan in custom.css opgehaald & toegewezen worden.
font_add_google("Open Sans")
showtext_auto() #showtext graphics device bij renderen ggplot; standaard werkt niet met andere fonts dan windows
