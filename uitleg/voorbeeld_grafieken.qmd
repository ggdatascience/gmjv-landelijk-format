...
-   **tabel_en_grafiek:** TRUE of FALSE. Als TRUE wordt er naast de grafiek ook code voor een tabel gegenereerd die d.m.v. een tabblad in te zien valt. LET OP: Hiervoor moeten codeblokken anders aangeroepen worden. Zie [Tabel en grafiek](text-en-layout.qmd#tabel-en-grafiek)
