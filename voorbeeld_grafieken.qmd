...
```{r, fig.width=12, fig.height=3, fig.alt=ggplot2::get_alt_text(plot)}
#Fig height & width settings zijn nodig om een gestapeld staafdiagram 
# op de juiste hoogte / breedte te krijgen
plot = monitor_df %>% 
  maak_staafdiagram_gestapeld(var_inhoud = "tevreden_lichaam_3cat",
...
```{r}
plot = monitor_df %>% maak_staafdiagram_uitsplitsing_naast_elkaar(
  var_inhoud = "vaak_stress",
