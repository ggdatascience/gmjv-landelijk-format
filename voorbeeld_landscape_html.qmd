...
#tijdelijke functie om 9 Onbekend te verwijderen

verwijder_9_onbekend <- function(data, var){
  value_labels <- val_labels(data[[var]])
  value_labels <- value_labels[value_labels!= 9]
  val_labels(data[[var]]) <- value_labels
...
#TODO tabelfunctie ombouwen naar test-monitordata
#monitor_df %>% maak_responstabel(crossings = "geslacht_2cat","leeftijd_3cat")
